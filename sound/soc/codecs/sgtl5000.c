				  ...
				  struct snd_soc_dai *dai)
{
	...
	if (substream->stream == SNDRV_PCM_STREAM_PLAYBACK) {
		if (sgtl5000->mono2both) {
			...
			snd_soc_component_update_bits(component, SGTL5000_CHIP_ANA_TEST2,
...
static int sgtl5000_probe(struct snd_soc_component *component)
{
	...
	if (sgtl5000->no_standby) {
		snd_soc_dapm_force_enable_pin(snd_soc_component_get_dapm(component), "LO");
		snd_soc_dapm_force_enable_pin(snd_soc_component_get_dapm(component), "HP");
...
static void sgtl5000_remove(struct snd_soc_component *component)
{
	struct sgtl5000_priv *sgtl5000 = snd_soc_component_get_drvdata(component);
