...
static int imx_rpmsg_probe(struct platform_device *pdev)
{
	...
	if (ret) {
		...
		} else if (of_device_is_compatible(np, "fus,imx7ulp-rpmsg-audio")) {
			data->dai.codecs->dai_name = "rpmsg-sgtl5000-hifi";
			data->dai.codecs->name = RPMSG_CODEC_DRV_NAME_SGTL5000;
