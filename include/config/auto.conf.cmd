...
ifneq "$(KERNELVERSION)" "5.4.3"
include/config/auto.conf: FORCE
endif
ifneq "$(CC_VERSION_TEXT)" "arm-linux-gcc (for F+S boards and modules) 8.3.0"
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "arm-linux-gcc"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "arm-linux-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "."
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "arm-linux-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "arm-linux-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
