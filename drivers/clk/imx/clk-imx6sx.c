...
static void __init imx6sx_clocks_init(struct device_node *ccm_node)
{
	...
	hws[IMX6SX_CLK_PCIE_REF] = imx_clk_hw_fixed_factor("pcie_ref", "pll6_bypass", 1, 5);
	...
	hws[IMX6SX_CLK_ENET2_REF] = imx_clk_hw_gate("enet2_ref", "enet2_div", base + 0xe0, 20);

	hws[IMX6SX_CLK_ENET_PTP_DIV] = imx_clk_hw_fixed_factor("enet_ptp_div", "pll6_bypass", 1, 20);
	hws[IMX6SX_CLK_ENET_PTP] = imx_clk_hw_gate("enet_ptp_25m", "enet_ptp_div", base + 0xe0, 21);
	...
	hws[IMX6SX_CLK_M4_PRE_SEL]         = imx_clk_hw_mux2("m4_pre_sel",       base + 0x34,  6,      3,      m4_pre_sels,       ARRAY_SIZE(m4_pre_sels));
	hws[IMX6SX_CLK_M4_SEL]             = imx_clk_hw_mux2("m4_sel",           base + 0x34,  0,      3,      m4_sels,           ARRAY_SIZE(m4_sels));
	...
	hws[IMX6SX_CLK_LCDIF1_PRE_SEL]     = clk_hw_register_mux(NULL, "lcdif1_pre_sel",  lcdif1_pre_sels,   ARRAY_SIZE(lcdif1_pre_sels), CLK_SET_PARENT_GATE, base + 0x38, 15, 3, 0, &imx_ccm_lock);
#endif
	...
	clk_set_parent(hws[IMX6SX_CLK_LDB_DI0_SEL]->clk, hws[IMX6SX_CLK_PLL5_VIDEO_DIV]->clk);
	...
	if (clk_get_parent(hws[IMX6SX_CLK_CAN_SEL]->clk) == hws[IMX6SX_CLK_DUMMY]->clk)
		/* default parent of can_sel clock is invalid, manually set it here */
		clk_set_parent(hws[IMX6SX_CLK_CAN_SEL]->clk, hws[IMX6SX_CLK_PLL3_60M]->clk);
